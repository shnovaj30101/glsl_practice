...
int main()
{
    ...
    // ------------------------------------
    Shader objShader("color.vs", "color3.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        objShader.use();
        objShader.setVec3("light.position", cameraPos);
        objShader.setVec3("light.direction", cameraFront);
        objShader.setFloat("light.innerCutOff",   glm::cos(glm::radians(12.5f)));
        ...
        objShader.setVec3("light.diffuse",  0.4f, 0.4f, 0.4f); // 将光照调暗了一些以搭配场景
